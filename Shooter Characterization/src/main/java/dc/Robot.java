...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(7, Sides.LEFT, false);

    CANSparkMax leftFollowerID8 = setupCANSparkMax(8, Sides.FOLLOWER, true);
    leftFollowerID8.follow(leftMotor, true);
